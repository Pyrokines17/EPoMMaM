...
# %bb.4:
	movq	792(%rsp), %rbp
.LBB6_5:
	vmovupd	176(%rsp), %xmm5                # 16-byte Reload
                                        # AlignMOV convert to UnAlignMOV 
...
.LBB6_7:
	...
	vmovups	400(%rsp), %xmm0                # 16-byte Reload
                                        # AlignMOV convert to UnAlignMOV 
	vmovlps	%xmm0, 64(%rsp)                 # 8-byte Folded Spill
	vmovddup	.LCPI6_1(%rip), %xmm0           # xmm0 = [1.0E+0,1.0E+0]
                                        # xmm0 = mem[0,0]
	vmovupd	176(%rsp), %xmm1                # 16-byte Reload
                                        # AlignMOV convert to UnAlignMOV 
	...
	vmovupd	%zmm0, 656(%rsp)                # 64-byte Spill
	vbroadcastsd	%xmm1, %zmm0
	vmovupd	%zmm0, 592(%rsp)                # 64-byte Spill
	vbroadcastsd	%xmm2, %zmm0
	vmovupd	%zmm0, 528(%rsp)                # 64-byte Spill
	vbroadcastsd	%xmm3, %zmm0
	vmovupd	%zmm0, 464(%rsp)                # 64-byte Spill
	leaq	160(%rsp), %rsi
	movl	$2, %edi
	vzeroupper
	callq	clock_gettime
...
.LBB6_8:                                #   in Loop: Header=BB6_10 Depth=1
	...
	vmovupd	%zmm0, 720(%rsp)                # 64-byte Spill
	movq	%r14, %r9
	movq	(%rsp), %r15                    # 8-byte Reload
	vmovupd	656(%rsp), %zmm21               # 64-byte Reload
	vmovupd	592(%rsp), %zmm22               # 64-byte Reload
	vmovupd	528(%rsp), %zmm23               # 64-byte Reload
	vmovupd	464(%rsp), %zmm24               # 64-byte Reload
	vbroadcastsd	.LCPI6_4(%rip), %zmm25  # zmm25 = [2.5E-1,2.5E-1,2.5E-1,2.5E-1,2.5E-1,2.5E-1,2.5E-1,2.5E-1]
	vmovupd	176(%rsp), %zmm31               # 64-byte Reload
.LBB6_9:                                #   in Loop: Header=BB6_10 Depth=1
	vmovupd	%zmm31, 176(%rsp)               # 64-byte Spill
	...
	vmovupd	%zmm0, 400(%rsp)                # 64-byte Spill
	movq	%rbp, %rdi
	movq	%r12, %rsi
	movq	352(%rsp), %rdx                 # 8-byte Reload
	movq	%r15, %rcx
	movl	$8, %r8d
	vmovupd	656(%rsp), %zmm0                # 64-byte Reload
	vmovups	592(%rsp), %zmm1                # 64-byte Reload
	vmovups	528(%rsp), %zmm2                # 64-byte Reload
	vbroadcastsd	.LCPI6_6(%rip), %zmm3   # zmm3 = [2.0E+0,2.0E+0,2.0E+0,2.0E+0,2.0E+0,2.0E+0,2.0E+0,2.0E+0]
	vbroadcastsd	.LCPI6_4(%rip), %zmm4   # zmm4 = [2.5E-1,2.5E-1,2.5E-1,2.5E-1,2.5E-1,2.5E-1,2.5E-1,2.5E-1]
	vmovups	464(%rsp), %zmm5                # 64-byte Reload
	vmovups	720(%rsp), %zmm6                # 64-byte Reload
	movq	%r14, %r9
	callq	_Z8calcLinePdS_mmiDv8_dS0_S0_S0_S0_S0_S0_S_
	vmovapd	%zmm0, %zmm6
	movq	%rbp, %rdi
	...
	movl	$8, %r8d
	vmovupd	656(%rsp), %zmm0                # 64-byte Reload
	vmovupd	592(%rsp), %zmm1                # 64-byte Reload
	vmovupd	528(%rsp), %zmm2                # 64-byte Reload
	vbroadcastsd	.LCPI6_6(%rip), %zmm3   # zmm3 = [2.0E+0,2.0E+0,2.0E+0,2.0E+0,2.0E+0,2.0E+0,2.0E+0,2.0E+0]
	vbroadcastsd	.LCPI6_4(%rip), %zmm4   # zmm4 = [2.5E-1,2.5E-1,2.5E-1,2.5E-1,2.5E-1,2.5E-1,2.5E-1,2.5E-1]
	vmovupd	464(%rsp), %zmm5                # 64-byte Reload
	movq	%r14, %r9
	callq	_Z8calcLinePdS_mmiDv8_dS0_S0_S0_S0_S0_S0_S_
	vbroadcastsd	.LCPI6_4(%rip), %zmm4   # zmm4 = [2.5E-1,2.5E-1,2.5E-1,2.5E-1,2.5E-1,2.5E-1,2.5E-1,2.5E-1]
	vbroadcastsd	.LCPI6_6(%rip), %zmm3   # zmm3 = [2.0E+0,2.0E+0,2.0E+0,2.0E+0,2.0E+0,2.0E+0,2.0E+0,2.0E+0]
...
.LBB6_10:                               # =>This Loop Header: Depth=1
	...
	movq	%rbx, %rcx
	movl	$8, %r8d
	vmovups	656(%rsp), %zmm0                # 64-byte Reload
	vmovups	592(%rsp), %zmm1                # 64-byte Reload
	vmovups	528(%rsp), %zmm2                # 64-byte Reload
	vmovups	464(%rsp), %zmm5                # 64-byte Reload
	movq	%rbp, %r9
	...
	movq	%rbp, %r9
	callq	_Z8calcLinePdS_mmiDv8_dS0_S0_S0_S0_S0_S0_S_
	vmovups	%zmm0, 176(%rsp)                # 64-byte Spill
	movl	$1, %edx
	vxorps	%xmm6, %xmm6, %xmm6
	movq	%rbp, %rdi
	movq	%r12, %rsi
...
.LBB6_13:                               #   in Loop: Header=BB6_14 Depth=2
	...
	movq	%r15, %rbp
	movq	(%rsp), %r15                    # 8-byte Reload
	vmovupd	-64(%rdi,%r15,8), %zmm1         # AlignMOV convert to UnAlignMOV 
	movq	400(%rsp), %rdi                 # 8-byte Reload
	vaddpd	-64(%rdi,%r15,8), %zmm1, %zmm1
	movb	$127, %dil
	kmovd	%edi, %k1
	vexpandpd	%zmm14, %zmm2 {%k1} {z}
	...
	addq	%rdi, %r10
	addq	%rdi, 80(%rsp)                  # 8-byte Folded Spill
	addq	%rdi, %rbx
	addq	%rdi, %r11
	addq	%rdi, 88(%rsp)                  # 8-byte Folded Spill
	addq	%rdi, %r8
	addq	%rdi, %rsi
...
.LBB6_14:                               #   Parent Loop BB6_10 Depth=1
	...
	imulq	%r15, %r11
	vmovupd	(%r9,%rdi,8), %zmm11            # AlignMOV convert to UnAlignMOV 
	vmovdqu64	64(%r9,%rdi,8), %zmm3   # AlignMOV convert to UnAlignMOV 
	vmovdqu64	(%r9,%r8,8), %zmm0      # AlignMOV convert to UnAlignMOV 
	vmovdqu64	64(%r9,%r8,8), %zmm2    # AlignMOV convert to UnAlignMOV 
	vmovupd	(%r9,%r11,8), %zmm8             # AlignMOV convert to UnAlignMOV 
	vmovdqu64	64(%r9,%r11,8), %zmm1   # AlignMOV convert to UnAlignMOV 
	vmovdqu64	(%r12,%rdi,8), %zmm9    # AlignMOV convert to UnAlignMOV 
	vmovdqu64	64(%r12,%rdi,8), %zmm4  # AlignMOV convert to UnAlignMOV 
	vmovapd	%zmm11, %zmm10
...
.LBB6_16:                               #   Parent Loop BB6_10 Depth=1
	...
	vmovdqu64	-64(%r9,%r10,8), %zmm11 # AlignMOV convert to UnAlignMOV 
	vmovdqu64	-64(%rdx,%r10,8), %zmm12 # AlignMOV convert to UnAlignMOV 
	vmovdqu64	-64(%rsi,%r10,8), %zmm13 # AlignMOV convert to UnAlignMOV 
	vmovdqu64	-64(%r14,%r10,8), %zmm15 # AlignMOV convert to UnAlignMOV 
	...
	valignq	$1, %zmm4, %zmm15, %zmm19       # zmm19 = zmm4[1,2,3,4,5,6,7],zmm15[0]
	vmovupd	(%rcx,%r10,8), %zmm20           # AlignMOV convert to UnAlignMOV 
	vaddpd	%zmm16, %zmm14, %zmm14
	vmulpd	%zmm14, %zmm21, %zmm14
	vaddpd	%zmm17, %zmm5, %zmm5
	vaddpd	%zmm18, %zmm7, %zmm7
	vaddpd	%zmm7, %zmm5, %zmm5
	vaddpd	(%r15,%r10,8), %zmm20, %zmm7
	...
	vfmadd231pd	%zmm25, %zmm7, %zmm5    # zmm5 = (zmm7 * zmm25) + zmm5
	vmulpd	%zmm5, %zmm24, %zmm5
	vsubpd	%zmm3, %zmm5, %zmm7
	vandpd	%zmm29, %zmm7, %zmm7
	vmaxpd	%zmm7, %zmm0, %zmm0
	vmovupd	%zmm5, (%rax,%r10,8)            # AlignMOV convert to UnAlignMOV 
	addq	$8, %r10
	...
	valignq	$7, %zmm4, %zmm15, %zmm8        # zmm8 = zmm4[7],zmm15[0,1,2,3,4,5,6]
	vmovapd	%zmm15, %zmm4
	vmovapd	%zmm13, %zmm1
	vmovapd	%zmm12, %zmm2
	vmovdqa64	%zmm11, %zmm3
...
.LBB6_18:                               #   in Loop: Header=BB6_14 Depth=2
	...
	movb	$127, %r15b
	kmovd	%r15d, %k1
	vexpandpd	%zmm14, %zmm1 {%k1} {z}
	vmovdqa64	%zmm11, %zmm2
	vpermt2pd	%zmm26, %zmm30, %zmm2
	vexpandpd	%zmm5, %zmm3 {%k1} {z}
	vpermt2pd	%zmm26, %zmm30, %zmm12
	vexpandpd	%zmm7, %zmm4 {%k1} {z}
	vexpandpd	%zmm8, %zmm5 {%k1} {z}
	movq	(%rsp), %r15                    # 8-byte Reload
	movq	%r14, 400(%rsp)                 # 8-byte Spill
	vmovupd	-64(%r14,%r15,8), %zmm7         # AlignMOV convert to UnAlignMOV 
	vpermt2pd	%zmm26, %zmm30, %zmm13
	...
	vexpandpd	%zmm9, %zmm4 {%k1} {z}
	vaddpd	-64(%r10,%r15,8), %zmm7, %zmm7
	vexpandpd	%zmm7, %zmm7 {%k1} {z}
	vaddpd	%zmm5, %zmm2, %zmm2
	vaddpd	%zmm7, %zmm2, %zmm2
	vfmadd213pd	%zmm1, %zmm22, %zmm8    # zmm8 = (zmm22 * zmm8) + zmm1
	vfmadd231pd	%zmm3, %zmm23, %zmm4    # zmm4 = (zmm23 * zmm3) + zmm4
	vaddpd	%zmm4, %zmm8, %zmm1
	vfmadd231pd	%zmm2, %zmm25, %zmm1    # zmm1 = (zmm25 * zmm2) + zmm1
	vmulpd	%zmm1, %zmm24, %zmm1
	vsubpd	%zmm11, %zmm1, %zmm2
	vexpandpd	%zmm2, %zmm2 {%k1} {z}
	imulq	%r15, %rdi
	vpandq	%zmm29, %zmm2, %zmm4
	vmovupd	%zmm1, -64(%r9,%r15,8)          # AlignMOV convert to UnAlignMOV 
	vmovupd	(%r11,%r8,8), %zmm10            # AlignMOV convert to UnAlignMOV 
	vmovdqu64	64(%r11,%r8,8), %zmm3   # AlignMOV convert to UnAlignMOV 
	vmovdqu64	(%r11,%rdi,8), %zmm7    # AlignMOV convert to UnAlignMOV 
	vmovdqu64	64(%r11,%rdi,8), %zmm2  # AlignMOV convert to UnAlignMOV 
	vmovupd	(%r9), %zmm8                    # AlignMOV convert to UnAlignMOV 
	vmovdqu64	64(%r9), %zmm1          # AlignMOV convert to UnAlignMOV 
	vmovdqu64	(%rsi,%r8,8), %zmm9     # AlignMOV convert to UnAlignMOV 
	vmaxpd	%zmm4, %zmm0, %zmm31
	vmovdqu64	64(%rsi,%r8,8), %zmm4   # AlignMOV convert to UnAlignMOV 
	vmovapd	%zmm10, %zmm0
	vpermt2pd	%zmm26, %zmm27, %zmm0
	...
	vmovupd	(%rsi,%rdi,8), %zmm14           # AlignMOV convert to UnAlignMOV 
	vmulpd	%zmm0, %zmm21, %zmm0
	vandpd	%zmm28, %zmm13, %zmm13
	vaddpd	%zmm15, %zmm16, %zmm15
	vaddpd	%zmm15, %zmm12, %zmm12
	movq	%r12, 376(%rsp)                 # 8-byte Spill
	vaddpd	(%r12), %zmm14, %zmm14
	...
	vfmadd231pd	%zmm9, %zmm25, %zmm0    # zmm0 = (zmm25 * zmm9) + zmm0
	vmulpd	%zmm0, %zmm24, %zmm9
	vsubpd	%zmm10, %zmm9, %zmm0
	vpternlogq	$128, %zmm28, %zmm29, %zmm0
	vmaxpd	%zmm0, %zmm6, %zmm0
	movq	32(%rsp), %rsi                  # 8-byte Reload
	vmovupd	%zmm9, (%rsi)                   # AlignMOV convert to UnAlignMOV 
...
.LBB6_20:                               #   Parent Loop BB6_10 Depth=1
                                        #     Parent Loop BB6_14 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vmovdqu64	-64(%r9,%r8,8), %zmm10  # AlignMOV convert to UnAlignMOV 
	vmovdqu64	-64(%r11,%r8,8), %zmm11 # AlignMOV convert to UnAlignMOV 
	vmovdqu64	64(%rax,%r8,8), %zmm12  # AlignMOV convert to UnAlignMOV 
	vmovdqu64	64(%rcx,%r8,8), %zmm14  # AlignMOV convert to UnAlignMOV 
	...
	vmovupd	%zmm5, (%r10,%r8,8)             # AlignMOV convert to UnAlignMOV 
	addq	$8, %r8
	...
	valignq	$7, %zmm4, %zmm14, %zmm8        # zmm8 = zmm4[7],zmm14[0,1,2,3,4,5,6]
	vmovapd	%zmm14, %zmm4
	vmovapd	%zmm12, %zmm1
	vmovapd	%zmm11, %zmm2
...
.LBB6_22:                               #   in Loop: Header=BB6_14 Depth=2
	...
	vmovupd	-64(%r8,%r9,8), %zmm7           # AlignMOV convert to UnAlignMOV 
	vpermt2pd	%zmm26, %zmm30, %zmm12
	vaddpd	%zmm1, %zmm2, %zmm1
	vmulpd	%zmm1, %zmm21, %zmm1
	...
	vmovupd	%zmm1, -64(%r8,%r9,8)           # AlignMOV convert to UnAlignMOV 
	movq	136(%rsp), %r9                  # 8-byte Reload
	vmovupd	(%r9,%rdi,8), %zmm11            # AlignMOV convert to UnAlignMOV 
	vmovdqu64	64(%r9,%rdi,8), %zmm3   # AlignMOV convert to UnAlignMOV 
	vmovdqu64	(%r9,%r14,8), %zmm7     # AlignMOV convert to UnAlignMOV 
	vmovdqu64	64(%r9,%r14,8), %zmm2   # AlignMOV convert to UnAlignMOV 
	vmovupd	(%r8), %zmm8                    # AlignMOV convert to UnAlignMOV 
	vmovdqu64	64(%r8), %zmm1          # AlignMOV convert to UnAlignMOV 
	vmovdqu64	(%r12,%rdi,8), %zmm9    # AlignMOV convert to UnAlignMOV 
	vmaxpd	%zmm4, %zmm0, %zmm6
	vmovdqu64	64(%r12,%rdi,8), %zmm4  # AlignMOV convert to UnAlignMOV 
	vmovapd	%zmm11, %zmm0
	vpermt2pd	%zmm26, %zmm27, %zmm0
	valignq	$1, %zmm11, %zmm3, %zmm5        # zmm5 = zmm11[1,2,3,4,5,6,7],zmm3[0]
	vpandq	%zmm28, %zmm5, %zmm10
	valignq	$1, %zmm7, %zmm2, %zmm12        # zmm12 = zmm7[1,2,3,4,5,6,7],zmm2[0]
	vaddpd	%zmm8, %zmm7, %zmm13
	valignq	$7, %zmm7, %zmm2, %zmm5         # zmm5 = zmm7[7],zmm2[0,1,2,3,4,5,6]
	vmovapd	%zmm7, %zmm14
	...
	vmovupd	(%r12,%r14,8), %zmm14           # AlignMOV convert to UnAlignMOV 
	vmulpd	%zmm0, %zmm21, %zmm0
	vandpd	%zmm28, %zmm13, %zmm13
	vaddpd	%zmm15, %zmm16, %zmm15
	vaddpd	%zmm15, %zmm12, %zmm12
	movq	400(%rsp), %rdi                 # 8-byte Reload
	vaddpd	(%rdi), %zmm14, %zmm14
	vandpd	%zmm28, %zmm10, %zmm10
	vandpd	%zmm28, %zmm14, %zmm14
	vaddpd	%zmm17, %zmm9, %zmm9
	vaddpd	%zmm9, %zmm14, %zmm9
	vfmadd213pd	%zmm0, %zmm22, %zmm13   # zmm13 = (zmm22 * zmm13) + zmm0
	vfmadd231pd	%zmm12, %zmm23, %zmm10  # zmm10 = (zmm23 * zmm12) + zmm10
	vaddpd	%zmm10, %zmm13, %zmm0
	vfmadd231pd	%zmm9, %zmm25, %zmm0    # zmm0 = (zmm25 * zmm9) + zmm0
	vmulpd	%zmm0, %zmm24, %zmm9
	vsubpd	%zmm11, %zmm9, %zmm0
	vpternlogq	$128, %zmm28, %zmm29, %zmm0
	vmovupd	720(%rsp), %zmm10               # 64-byte Reload
	vmaxpd	%zmm0, %zmm10, %zmm0
	movq	16(%rsp), %rdi                  # 8-byte Reload
	vmovupd	%zmm9, (%rdi)                   # AlignMOV convert to UnAlignMOV 
	vaddpd	%zmm1, %zmm2, %zmm10
	vaddpd	%zmm4, %zmm4, %zmm9
	valignq	$7, %zmm11, %zmm3, %zmm14       # zmm14 = zmm11[7],zmm3[0,1,2,3,4,5,6]
	cmpq	$9, %r13
...
.LBB6_24:                               #   Parent Loop BB6_10 Depth=1
                                        #     Parent Loop BB6_14 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vmovdqu64	-64(%rbp,%rdi,8), %zmm11 # AlignMOV convert to UnAlignMOV 
	vmovdqu64	-64(%r15,%rdi,8), %zmm12 # AlignMOV convert to UnAlignMOV 
	vmovdqu64	-64(%rdx,%rdi,8), %zmm13 # AlignMOV convert to UnAlignMOV 
	vmovdqu64	64(%rbx,%rdi,8), %zmm15 # AlignMOV convert to UnAlignMOV 
	valignq	$1, %zmm3, %zmm11, %zmm16       # zmm16 = zmm3[1,2,3,4,5,6,7],zmm11[0]
	valignq	$1, %zmm2, %zmm12, %zmm17       # zmm17 = zmm2[1,2,3,4,5,6,7],zmm12[0]
	valignq	$1, %zmm1, %zmm13, %zmm18       # zmm18 = zmm1[1,2,3,4,5,6,7],zmm13[0]
	valignq	$1, %zmm4, %zmm15, %zmm19       # zmm19 = zmm4[1,2,3,4,5,6,7],zmm15[0]
	vmovupd	(%rsi,%rdi,8), %zmm20           # AlignMOV convert to UnAlignMOV 
	vaddpd	%zmm16, %zmm14, %zmm14
	vmulpd	%zmm14, %zmm21, %zmm14
	vaddpd	%zmm17, %zmm5, %zmm5
	vaddpd	%zmm18, %zmm7, %zmm7
	vaddpd	%zmm7, %zmm5, %zmm5
	vaddpd	(%rcx,%rdi,8), %zmm20, %zmm7
	vaddpd	%zmm19, %zmm8, %zmm8
	vaddpd	%zmm8, %zmm7, %zmm7
	vfmadd231pd	%zmm10, %zmm22, %zmm14  # zmm14 = (zmm22 * zmm10) + zmm14
	vfmadd213pd	%zmm9, %zmm23, %zmm5    # zmm5 = (zmm23 * zmm5) + zmm9
	...
	vandpd	%zmm29, %zmm7, %zmm7
	vmaxpd	%zmm7, %zmm0, %zmm0
	vmovupd	%zmm5, (%r8,%rdi,8)             # AlignMOV convert to UnAlignMOV 
	addq	$8, %rdi
	vaddpd	%zmm13, %zmm12, %zmm10
	vaddpd	%zmm15, %zmm15, %zmm9
	valignq	$7, %zmm3, %zmm11, %zmm14       # zmm14 = zmm3[7],zmm11[0,1,2,3,4,5,6]
...
.LBB6_27:
	movq	%rbp, %r15
	vmovupd	176(%rsp), %zmm2                # 64-byte Reload
	...
	vmovupd	400(%rsp), %zmm2                # 64-byte Reload
	vextractf64x4	$1, %zmm2, %ymm1
	vmaxpd	%zmm1, %zmm2, %zmm1
	vextractf128	$1, %ymm1, %xmm2
	vmaxpd	%xmm2, %xmm1, %xmm1
...
# %bb.64:
	movq	792(%rsp), %rax
	movq	-24(%rax), %rax
	leaq	792(%rsp,%rax), %rdi
	movl	824(%rsp,%rax), %esi
	orl	$4, %esi
.Ltmp48:
	callq	_ZNSt9basic_iosIcSt11char_traitsIcEE5clearESt12_Ios_Iostate
.Ltmp49:
...
# %bb.73:
	movq	1304(%rsp), %rax
	movq	-24(%rax), %rax
	leaq	1304(%rsp,%rax), %rdi
	movl	1336(%rsp,%rax), %esi
	orl	$4, %esi
.Ltmp62:
	callq	_ZNSt9basic_iosIcSt11char_traitsIcEE5clearESt12_Ios_Iostate
.Ltmp63:
