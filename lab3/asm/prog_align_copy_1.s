...
# %bb.1:
	...
	vmovupd	%xmm1, 272(%rsp)                # 16-byte Spill
                                        # AlignMOV convert to UnAlignMOV 
	vmovq	%xmm0, %rbx
...
# %bb.4:
	movq	1080(%rsp), %r14
.LBB6_5:
	vmovupd	272(%rsp), %xmm5                # 16-byte Reload
                                        # AlignMOV convert to UnAlignMOV 
...
.LBB6_7:
	...
	vmovups	208(%rsp), %xmm0                # 16-byte Reload
                                        # AlignMOV convert to UnAlignMOV 
	vmovlps	%xmm0, 72(%rsp)                 # 8-byte Folded Spill
	vmovddup	.LCPI6_1(%rip), %xmm0           # xmm0 = [1.0E+0,1.0E+0]
                                        # xmm0 = mem[0,0]
	vmovupd	272(%rsp), %xmm1                # 16-byte Reload
                                        # AlignMOV convert to UnAlignMOV 
	...
	vmovupd	%zmm0, 752(%rsp)                # 64-byte Spill
	vbroadcastsd	%xmm1, %zmm0
	vmovupd	%zmm0, 688(%rsp)                # 64-byte Spill
	vbroadcastsd	%xmm2, %zmm0
	vmovupd	%zmm0, 624(%rsp)                # 64-byte Spill
	...
	leaq	128(%r14,%rax), %rdx
	movq	%rdx, 416(%rsp)                 # 8-byte Spill
	leaq	128(%r14,%rcx), %rcx
	...
	leaq	128(%r12,%rbp,8), %rax
	movq	%rax, 376(%rsp)                 # 8-byte Spill
	leaq	(%r12,%rbp,8), %rax
	movq	%rax, 368(%rsp)                 # 8-byte Spill
	leaq	128(%r14), %rax
	movq	%rax, 360(%rsp)                 # 8-byte Spill
	leaq	128(%r14,%rbp,8), %rax
...
.LBB6_8:                                #   in Loop: Header=BB6_10 Depth=1
	...
	movq	16(%rsp), %rbp                  # 8-byte Reload
	vmovupd	752(%rsp), %zmm20               # 64-byte Reload
	vmovupd	688(%rsp), %zmm21               # 64-byte Reload
	vmovupd	624(%rsp), %zmm22               # 64-byte Reload
	vmovupd	560(%rsp), %zmm23               # 64-byte Reload
	vbroadcastsd	.LCPI6_4(%rip), %zmm24  # zmm24 = [2.5E-1,2.5E-1,2.5E-1,2.5E-1,2.5E-1,2.5E-1,2.5E-1,2.5E-1]
	vmovupd	272(%rsp), %zmm30               # 64-byte Reload
	vmovupd	208(%rsp), %zmm31               # 64-byte Reload
.LBB6_9:                                #   in Loop: Header=BB6_10 Depth=1
	vmovupd	%zmm30, 272(%rsp)               # 64-byte Spill
	...
	vbroadcastsd	.LCPI6_4(%rip), %zmm4   # zmm4 = [2.5E-1,2.5E-1,2.5E-1,2.5E-1,2.5E-1,2.5E-1,2.5E-1,2.5E-1]
	vmovups	560(%rsp), %zmm5                # 64-byte Reload
	vmovups	944(%rsp), %zmm6                # 64-byte Reload
	movq	%r12, %r9
	callq	_Z8calcLinePdS_mmiDv8_dS0_S0_S0_S0_S0_S0_S_
	vmovups	%zmm0, 816(%rsp)                # 64-byte Spill
	movq	%r12, %rdi
	movq	%rbx, %rsi
	movq	%r13, %rdx
	movq	%rbp, %rcx
	...
	vbroadcastsd	.LCPI6_4(%rip), %zmm4   # zmm4 = [2.5E-1,2.5E-1,2.5E-1,2.5E-1,2.5E-1,2.5E-1,2.5E-1,2.5E-1]
	vmovups	560(%rsp), %zmm5                # 64-byte Reload
	vmovups	208(%rsp), %zmm6                # 64-byte Reload
	movq	%r14, %r9
	callq	_Z8calcLinePdS_mmiDv8_dS0_S0_S0_S0_S0_S0_S_
	vmovups	%zmm0, 208(%rsp)                # 64-byte Spill
	movq	%r14, %rdi
	...
	movq	%rbp, %rcx
	movl	$8, %r8d
	vmovupd	752(%rsp), %zmm0                # 64-byte Reload
	vmovups	688(%rsp), %zmm1                # 64-byte Reload
	vmovups	624(%rsp), %zmm2                # 64-byte Reload
	vbroadcastsd	.LCPI6_6(%rip), %zmm3   # zmm3 = [2.0E+0,2.0E+0,2.0E+0,2.0E+0,2.0E+0,2.0E+0,2.0E+0,2.0E+0]
	vbroadcastsd	.LCPI6_4(%rip), %zmm4   # zmm4 = [2.5E-1,2.5E-1,2.5E-1,2.5E-1,2.5E-1,2.5E-1,2.5E-1,2.5E-1]
	vmovups	560(%rsp), %zmm5                # 64-byte Reload
	vmovups	816(%rsp), %zmm6                # 64-byte Reload
	movq	%r12, %r9
	callq	_Z8calcLinePdS_mmiDv8_dS0_S0_S0_S0_S0_S0_S_
	vmovapd	%zmm0, %zmm6
	movq	%r14, %rdi
	...
	movl	$8, %r8d
	vmovupd	752(%rsp), %zmm0                # 64-byte Reload
	vmovupd	688(%rsp), %zmm1                # 64-byte Reload
	vmovupd	624(%rsp), %zmm2                # 64-byte Reload
	vbroadcastsd	.LCPI6_6(%rip), %zmm3   # zmm3 = [2.0E+0,2.0E+0,2.0E+0,2.0E+0,2.0E+0,2.0E+0,2.0E+0,2.0E+0]
	vbroadcastsd	.LCPI6_4(%rip), %zmm4   # zmm4 = [2.5E-1,2.5E-1,2.5E-1,2.5E-1,2.5E-1,2.5E-1,2.5E-1,2.5E-1]
	vmovupd	560(%rsp), %zmm5                # 64-byte Reload
	movq	%r12, %r9
	callq	_Z8calcLinePdS_mmiDv8_dS0_S0_S0_S0_S0_S0_S_
	vbroadcastsd	.LCPI6_4(%rip), %zmm4   # zmm4 = [2.5E-1,2.5E-1,2.5E-1,2.5E-1,2.5E-1,2.5E-1,2.5E-1,2.5E-1]
	vbroadcastsd	.LCPI6_6(%rip), %zmm3   # zmm3 = [2.0E+0,2.0E+0,2.0E+0,2.0E+0,2.0E+0,2.0E+0,2.0E+0,2.0E+0]
...
.LBB6_10:                               # =>This Loop Header: Depth=1
	...
	vbroadcastsd	.LCPI6_4(%rip), %zmm4   # zmm4 = [2.5E-1,2.5E-1,2.5E-1,2.5E-1,2.5E-1,2.5E-1,2.5E-1,2.5E-1]
	vmovups	560(%rsp), %zmm5                # 64-byte Reload
	vmovups	272(%rsp), %zmm6                # 64-byte Reload
	movq	%r14, %r9
	callq	_Z8calcLinePdS_mmiDv8_dS0_S0_S0_S0_S0_S0_S_
	vmovups	%zmm0, 272(%rsp)                # 64-byte Spill
	movl	$2, %edx
	...
	vbroadcastsd	.LCPI6_4(%rip), %zmm4   # zmm4 = [2.5E-1,2.5E-1,2.5E-1,2.5E-1,2.5E-1,2.5E-1,2.5E-1,2.5E-1]
	vmovups	560(%rsp), %zmm5                # 64-byte Reload
	vmovupd	208(%rsp), %zmm6                # 64-byte Reload
	movq	%r12, %r9
	callq	_Z8calcLinePdS_mmiDv8_dS0_S0_S0_S0_S0_S0_S_
	vmovups	%zmm0, 208(%rsp)                # 64-byte Spill
	movl	$1, %edx
	...
	cmpq	$5, 72(%rsp)                    # 8-byte Folded Reload
	jb	.LBB6_8
# %bb.11:                               #   in Loop: Header=BB6_10 Depth=1
	...
	vmovupd	560(%rsp), %zmm23               # 64-byte Reload
	vbroadcastsd	.LCPI6_4(%rip), %zmm24  # zmm24 = [2.5E-1,2.5E-1,2.5E-1,2.5E-1,2.5E-1,2.5E-1,2.5E-1,2.5E-1]
	vmovupd	.LCPI6_7(%rip), %zmm25          # zmm25 = [8,0,1,2,3,4,5,6]
                                        # AlignMOV convert to UnAlignMOV 
	vpmovsxbq	.LCPI6_12(%rip), %zmm26 # zmm26 = [0,18446744073709551615,18446744073709551615,18446744073709551615,18446744073709551615,18446744073709551615,18446744073709551615,18446744073709551615]
	vpbroadcastq	.LCPI6_9(%rip), %zmm27  # zmm27 = [NaN,NaN,NaN,NaN,NaN,NaN,NaN,NaN]
	vmovupd	.LCPI6_10(%rip), %zmm28         # zmm28 = [8,2,3,4,5,6,7,0]
                                        # AlignMOV convert to UnAlignMOV 
	vxorpd	%xmm29, %xmm29, %xmm29
	vmovupd	272(%rsp), %zmm30               # 64-byte Reload
	vmovupd	208(%rsp), %zmm31               # 64-byte Reload
	jmp	.LBB6_14
	.p2align	4, 0x90
...
.LBB6_13:                               #   in Loop: Header=BB6_14 Depth=2
	...
	leaq	(%rbp,%r10,8), %r10
	movq	16(%rsp), %rbp                  # 8-byte Reload
	vmovupd	-64(%r10,%rbp,8), %zmm0         # AlignMOV convert to UnAlignMOV 
	vaddpd	-64(%r12,%rbp,8), %zmm0, %zmm0
	movq	%rcx, %r10
	movb	$127, %cl
	kmovd	%ecx, %k1
	vexpandpd	%zmm13, %zmm2 {%k1} {z}
	vmovdqa64	%zmm10, %zmm3
	vpermt2pd	%zmm29, %zmm28, %zmm3
	vexpandpd	%zmm5, %zmm4 {%k1} {z}
	vpermt2pd	%zmm29, %zmm28, %zmm11
	vexpandpd	%zmm6, %zmm5 {%k1} {z}
	vpermt2pd	%zmm29, %zmm28, %zmm12
	vexpandpd	%zmm7, %zmm6 {%k1} {z}
	vaddpd	%zmm2, %zmm3, %zmm2
	vmulpd	%zmm2, %zmm20, %zmm2
	vexpandpd	%zmm9, %zmm7 {%k1} {z}
	vaddpd	%zmm4, %zmm11, %zmm4
	vaddpd	%zmm5, %zmm12, %zmm5
	vexpandpd	%zmm8, %zmm8 {%k1} {z}
	vexpandpd	%zmm0, %zmm0 {%k1} {z}
	vaddpd	%zmm5, %zmm4, %zmm4
	vaddpd	%zmm6, %zmm3, %zmm3
	vaddpd	%zmm0, %zmm3, %zmm0
	vfmadd213pd	%zmm2, %zmm21, %zmm7    # zmm7 = (zmm21 * zmm7) + zmm2
	vfmadd231pd	%zmm4, %zmm22, %zmm8    # zmm8 = (zmm22 * zmm4) + zmm8
	vaddpd	%zmm8, %zmm7, %zmm2
	vfmadd231pd	%zmm24, %zmm0, %zmm2    # zmm2 = (zmm0 * zmm24) + zmm2
	vmulpd	%zmm2, %zmm23, %zmm0
	vsubpd	%zmm10, %zmm0, %zmm2
	vexpandpd	%zmm2, %zmm2 {%k1} {z}
	vpandq	%zmm27, %zmm2, %zmm2
	vmaxpd	%zmm2, %zmm1, %zmm1
	vmovupd	%zmm1, 944(%rsp)                # 64-byte Spill
	movq	208(%rsp), %rcx                 # 8-byte Reload
	vmovupd	%zmm0, -64(%rcx,%rbp,8)         # AlignMOV convert to UnAlignMOV 
	...
	addq	%rcx, 104(%rsp)                 # 8-byte Folded Spill
...
.LBB6_14:                               #   Parent Loop BB6_10 Depth=1
	...
	movq	%rcx, %r12
	imulq	%rbp, %r12
	vmovupd	(%r13,%r11,8), %zmm10           # AlignMOV convert to UnAlignMOV 
	vmovdqu64	64(%r13,%r11,8), %zmm3  # AlignMOV convert to UnAlignMOV 
	vmovdqu64	(%r13,%r10,8), %zmm0    # AlignMOV convert to UnAlignMOV 
	vmovdqu64	64(%r13,%r10,8), %zmm2  # AlignMOV convert to UnAlignMOV 
	vmovupd	(%r13,%r12,8), %zmm7            # AlignMOV convert to UnAlignMOV 
	vmovdqu64	64(%r13,%r12,8), %zmm1  # AlignMOV convert to UnAlignMOV 
	movq	8(%rsp), %rcx                   # 8-byte Reload
	vmovdqu64	(%rcx,%r11,8), %zmm8    # AlignMOV convert to UnAlignMOV 
	vmovdqu64	64(%rcx,%r11,8), %zmm4  # AlignMOV convert to UnAlignMOV 
	vmovapd	%zmm10, %zmm9
	vpermt2pd	%zmm29, %zmm25, %zmm9
	valignq	$1, %zmm10, %zmm3, %zmm5        # zmm5 = zmm10[1,2,3,4,5,6,7],zmm3[0]
	vpandq	%zmm26, %zmm5, %zmm11
	valignq	$1, %zmm0, %zmm2, %zmm6         # zmm6 = zmm0[1,2,3,4,5,6,7],zmm2[0]
	vaddpd	%zmm7, %zmm0, %zmm12
	valignq	$7, %zmm0, %zmm2, %zmm5         # zmm5 = zmm0[7],zmm2[0,1,2,3,4,5,6]
	vpermt2pd	%zmm29, %zmm25, %zmm0
	vpandq	%zmm26, %zmm6, %zmm13
	valignq	$1, %zmm7, %zmm1, %zmm14        # zmm14 = zmm7[1,2,3,4,5,6,7],zmm1[0]
	valignq	$7, %zmm7, %zmm1, %zmm6         # zmm6 = zmm7[7],zmm1[0,1,2,3,4,5,6]
	vmovapd	%zmm7, %zmm15
	vpermt2pd	%zmm29, %zmm25, %zmm15
	vpandq	%zmm26, %zmm14, %zmm14
	valignq	$1, %zmm8, %zmm4, %zmm16        # zmm16 = zmm8[1,2,3,4,5,6,7],zmm4[0]
	vaddpd	%zmm11, %zmm9, %zmm9
	vaddpd	%zmm8, %zmm8, %zmm11
	valignq	$7, %zmm8, %zmm4, %zmm7         # zmm7 = zmm8[7],zmm4[0,1,2,3,4,5,6]
	vpermt2pd	%zmm29, %zmm25, %zmm8
	vpandq	%zmm26, %zmm16, %zmm16
	vaddpd	%zmm13, %zmm0, %zmm0
	vmovupd	(%rcx,%r10,8), %zmm13           # AlignMOV convert to UnAlignMOV 
	vmulpd	%zmm9, %zmm20, %zmm9
	vandpd	%zmm26, %zmm12, %zmm12
	vaddpd	%zmm14, %zmm15, %zmm14
	vaddpd	%zmm14, %zmm0, %zmm0
	vaddpd	(%rcx,%r12,8), %zmm13, %zmm13
	vandpd	%zmm26, %zmm11, %zmm11
	vandpd	%zmm26, %zmm13, %zmm13
	vaddpd	%zmm16, %zmm8, %zmm8
	vaddpd	%zmm8, %zmm13, %zmm8
	vfmadd213pd	%zmm9, %zmm21, %zmm12   # zmm12 = (zmm21 * zmm12) + zmm9
	vfmadd231pd	%zmm0, %zmm22, %zmm11   # zmm11 = (zmm22 * zmm0) + zmm11
	vaddpd	%zmm11, %zmm12, %zmm0
	vfmadd231pd	%zmm24, %zmm8, %zmm0    # zmm0 = (zmm8 * zmm24) + zmm0
	vmulpd	%zmm0, %zmm23, %zmm8
	vsubpd	%zmm10, %zmm8, %zmm0
	vpternlogq	$128, %zmm27, %zmm26, %zmm0
	vmaxpd	%zmm0, %zmm30, %zmm0
	movq	24(%rsp), %rcx                  # 8-byte Reload
	vmovupd	%zmm8, (%rcx,%r11,8)            # AlignMOV convert to UnAlignMOV 
	vaddpd	%zmm1, %zmm2, %zmm9
	vaddpd	%zmm4, %zmm4, %zmm8
...
.LBB6_16:                               #   Parent Loop BB6_10 Depth=1
	...
	vmovdqu64	-64(%rcx,%rbp,8), %zmm10 # AlignMOV convert to UnAlignMOV 
	vmovdqu64	-64(%rax,%rbp,8), %zmm11 # AlignMOV convert to UnAlignMOV 
	vmovdqu64	-64(%rdx,%rbp,8), %zmm12 # AlignMOV convert to UnAlignMOV 
	vmovdqu64	-64(%r13,%rbp,8), %zmm14 # AlignMOV convert to UnAlignMOV 
	...
	valignq	$1, %zmm4, %zmm14, %zmm18       # zmm18 = zmm4[1,2,3,4,5,6,7],zmm14[0]
	vmovupd	(%rsi,%rbp,8), %zmm19           # AlignMOV convert to UnAlignMOV 
	vaddpd	%zmm15, %zmm13, %zmm13
	vmulpd	%zmm13, %zmm20, %zmm13
	vaddpd	%zmm16, %zmm5, %zmm5
	vaddpd	%zmm17, %zmm6, %zmm6
	vaddpd	%zmm6, %zmm5, %zmm5
	vaddpd	(%rdi,%rbp,8), %zmm19, %zmm6
	vaddpd	%zmm18, %zmm7, %zmm7
	vaddpd	%zmm7, %zmm6, %zmm6
	vfmadd231pd	%zmm9, %zmm21, %zmm13   # zmm13 = (zmm21 * zmm9) + zmm13
	vfmadd213pd	%zmm8, %zmm22, %zmm5    # zmm5 = (zmm22 * zmm5) + zmm8
	vaddpd	%zmm5, %zmm13, %zmm5
	vfmadd231pd	%zmm24, %zmm6, %zmm5    # zmm5 = (zmm6 * zmm24) + zmm5
	vmulpd	%zmm5, %zmm23, %zmm5
	vsubpd	%zmm3, %zmm5, %zmm6
	vandpd	%zmm27, %zmm6, %zmm6
	vmaxpd	%zmm6, %zmm0, %zmm0
	vmovupd	%zmm5, (%r8,%rbp,8)             # AlignMOV convert to UnAlignMOV 
	addq	$8, %rbp
	vaddpd	%zmm12, %zmm11, %zmm9
	vaddpd	%zmm14, %zmm14, %zmm8
	valignq	$7, %zmm3, %zmm10, %zmm13       # zmm13 = zmm3[7],zmm10[0,1,2,3,4,5,6]
	valignq	$7, %zmm2, %zmm11, %zmm5        # zmm5 = zmm2[7],zmm11[0,1,2,3,4,5,6]
	valignq	$7, %zmm1, %zmm12, %zmm6        # zmm6 = zmm1[7],zmm12[0,1,2,3,4,5,6]
	valignq	$7, %zmm4, %zmm14, %zmm7        # zmm7 = zmm4[7],zmm14[0,1,2,3,4,5,6]
	vmovapd	%zmm14, %zmm4
	vmovapd	%zmm12, %zmm1
	vmovapd	%zmm11, %zmm2
	vmovdqa64	%zmm10, %zmm3
...
.LBB6_18:                               #   in Loop: Header=BB6_14 Depth=2
	...
	movb	$127, %dl
	kmovd	%edx, %k1
	vexpandpd	%zmm13, %zmm1 {%k1} {z}
	vmovdqa64	%zmm10, %zmm2
	vpermt2pd	%zmm29, %zmm28, %zmm2
	vexpandpd	%zmm5, %zmm3 {%k1} {z}
	vpermt2pd	%zmm29, %zmm28, %zmm11
	vexpandpd	%zmm6, %zmm4 {%k1} {z}
	vexpandpd	%zmm7, %zmm5 {%k1} {z}
	movq	16(%rsp), %rdx                  # 8-byte Reload
	movq	%rdi, 208(%rsp)                 # 8-byte Spill
	vmovupd	-64(%rdi,%rdx,8), %zmm6         # AlignMOV convert to UnAlignMOV 
	vpermt2pd	%zmm29, %zmm28, %zmm12
	vaddpd	%zmm1, %zmm2, %zmm1
	vmulpd	%zmm1, %zmm20, %zmm1
	vexpandpd	%zmm9, %zmm7 {%k1} {z}
	vaddpd	%zmm3, %zmm11, %zmm3
	vaddpd	%zmm4, %zmm12, %zmm4
	vaddpd	%zmm4, %zmm3, %zmm3
	vexpandpd	%zmm8, %zmm4 {%k1} {z}
	vaddpd	-64(%r13,%rdx,8), %zmm6, %zmm6
	vexpandpd	%zmm6, %zmm6 {%k1} {z}
	vaddpd	%zmm5, %zmm2, %zmm2
	vaddpd	%zmm6, %zmm2, %zmm2
	vfmadd213pd	%zmm1, %zmm21, %zmm7    # zmm7 = (zmm21 * zmm7) + zmm1
	vfmadd231pd	%zmm3, %zmm22, %zmm4    # zmm4 = (zmm22 * zmm3) + zmm4
	vaddpd	%zmm4, %zmm7, %zmm1
	vfmadd231pd	%zmm2, %zmm24, %zmm1    # zmm1 = (zmm24 * zmm2) + zmm1
	vmulpd	%zmm1, %zmm23, %zmm1
	vsubpd	%zmm10, %zmm1, %zmm2
	vexpandpd	%zmm2, %zmm2 {%k1} {z}
	imulq	%rdx, %r11
	vpandq	%zmm27, %zmm2, %zmm3
	vmovupd	%zmm1, -64(%r12,%rdx,8)         # AlignMOV convert to UnAlignMOV 
	vmovupd	(%rbp,%r10,8), %zmm10           # AlignMOV convert to UnAlignMOV 
	vmovdqu64	64(%rbp,%r10,8), %zmm4  # AlignMOV convert to UnAlignMOV 
	vmovdqu64	(%rbp,%r11,8), %zmm6    # AlignMOV convert to UnAlignMOV 
	vmovdqu64	64(%rbp,%r11,8), %zmm2  # AlignMOV convert to UnAlignMOV 
	vmovupd	(%r12), %zmm7                   # AlignMOV convert to UnAlignMOV 
	vmovdqu64	64(%r12), %zmm1         # AlignMOV convert to UnAlignMOV 
	vmovdqu64	(%rcx,%r10,8), %zmm8    # AlignMOV convert to UnAlignMOV 
	vmaxpd	%zmm3, %zmm0, %zmm30
	vmovdqu64	64(%rcx,%r10,8), %zmm0  # AlignMOV convert to UnAlignMOV 
	vmovapd	%zmm10, %zmm3
	vpermt2pd	%zmm29, %zmm25, %zmm3
	valignq	$1, %zmm10, %zmm4, %zmm5        # zmm5 = zmm10[1,2,3,4,5,6,7],zmm4[0]
	vpandq	%zmm26, %zmm5, %zmm9
	valignq	$1, %zmm6, %zmm2, %zmm11        # zmm11 = zmm6[1,2,3,4,5,6,7],zmm2[0]
	vaddpd	%zmm7, %zmm6, %zmm12
	valignq	$7, %zmm6, %zmm2, %zmm5         # zmm5 = zmm6[7],zmm2[0,1,2,3,4,5,6]
	vmovapd	%zmm6, %zmm13
	vpermt2pd	%zmm29, %zmm25, %zmm13
	vpandq	%zmm26, %zmm11, %zmm11
	valignq	$1, %zmm7, %zmm1, %zmm14        # zmm14 = zmm7[1,2,3,4,5,6,7],zmm1[0]
	valignq	$7, %zmm7, %zmm1, %zmm6         # zmm6 = zmm7[7],zmm1[0,1,2,3,4,5,6]
	vmovapd	%zmm7, %zmm15
	vpermt2pd	%zmm29, %zmm25, %zmm15
	vpandq	%zmm26, %zmm14, %zmm14
	valignq	$1, %zmm8, %zmm0, %zmm16        # zmm16 = zmm8[1,2,3,4,5,6,7],zmm0[0]
	vaddpd	%zmm9, %zmm3, %zmm3
	vaddpd	%zmm8, %zmm8, %zmm9
	valignq	$7, %zmm8, %zmm0, %zmm7         # zmm7 = zmm8[7],zmm0[0,1,2,3,4,5,6]
	vpermt2pd	%zmm29, %zmm25, %zmm8
	vpandq	%zmm26, %zmm16, %zmm16
	vaddpd	%zmm11, %zmm13, %zmm11
	vmovupd	(%rcx,%r11,8), %zmm13           # AlignMOV convert to UnAlignMOV 
	vmulpd	%zmm3, %zmm20, %zmm3
	vandpd	%zmm26, %zmm12, %zmm12
	vaddpd	%zmm14, %zmm15, %zmm14
	vaddpd	%zmm14, %zmm11, %zmm11
	movq	880(%rsp), %rcx                 # 8-byte Reload
	vaddpd	(%rcx), %zmm13, %zmm13
	vandpd	%zmm26, %zmm9, %zmm9
	vandpd	%zmm26, %zmm13, %zmm13
	vaddpd	%zmm16, %zmm8, %zmm8
	vaddpd	%zmm8, %zmm13, %zmm8
	vfmadd213pd	%zmm3, %zmm21, %zmm12   # zmm12 = (zmm21 * zmm12) + zmm3
	vfmadd231pd	%zmm11, %zmm22, %zmm9   # zmm9 = (zmm22 * zmm11) + zmm9
	vaddpd	%zmm9, %zmm12, %zmm3
	vfmadd231pd	%zmm8, %zmm24, %zmm3    # zmm3 = (zmm24 * zmm8) + zmm3
	vmulpd	%zmm3, %zmm23, %zmm8
	vsubpd	%zmm10, %zmm8, %zmm3
	vpternlogq	$128, %zmm26, %zmm27, %zmm3
	vmaxpd	%zmm3, %zmm31, %zmm3
	movq	816(%rsp), %rcx                 # 8-byte Reload
	vmovupd	%zmm8, (%rcx)                   # AlignMOV convert to UnAlignMOV 
	vaddpd	%zmm1, %zmm2, %zmm9
	vaddpd	%zmm0, %zmm0, %zmm8
	valignq	$7, %zmm10, %zmm4, %zmm13       # zmm13 = zmm10[7],zmm4[0,1,2,3,4,5,6]
	cmpq	$9, %r15
	jb	.LBB6_21
# %bb.19:                               #   in Loop: Header=BB6_14 Depth=2
	...
	.p2align	4, 0x90
.LBB6_20:                               #   Parent Loop BB6_10 Depth=1
                                        #     Parent Loop BB6_14 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vmovdqu64	-64(%rcx,%r10,8), %zmm10 # AlignMOV convert to UnAlignMOV 
	vmovdqu64	-64(%rbx,%r10,8), %zmm11 # AlignMOV convert to UnAlignMOV 
	vmovdqu64	64(%r8,%r10,8), %zmm12  # AlignMOV convert to UnAlignMOV 
	vmovdqu64	64(%rsi,%r10,8), %zmm14 # AlignMOV convert to UnAlignMOV 
	valignq	$1, %zmm4, %zmm10, %zmm15       # zmm15 = zmm4[1,2,3,4,5,6,7],zmm10[0]
	valignq	$1, %zmm2, %zmm11, %zmm16       # zmm16 = zmm2[1,2,3,4,5,6,7],zmm11[0]
	valignq	$1, %zmm1, %zmm12, %zmm17       # zmm17 = zmm1[1,2,3,4,5,6,7],zmm12[0]
	valignq	$1, %zmm0, %zmm14, %zmm18       # zmm18 = zmm0[1,2,3,4,5,6,7],zmm14[0]
	vmovupd	(%r14,%r10,8), %zmm19           # AlignMOV convert to UnAlignMOV 
	vaddpd	%zmm15, %zmm13, %zmm13
	vmulpd	%zmm13, %zmm20, %zmm13
	vaddpd	%zmm16, %zmm5, %zmm5
	vaddpd	%zmm17, %zmm6, %zmm6
	vaddpd	%zmm6, %zmm5, %zmm5
	vaddpd	(%rdx,%r10,8), %zmm19, %zmm6
	vaddpd	%zmm18, %zmm7, %zmm7
	vaddpd	%zmm7, %zmm6, %zmm6
	vfmadd231pd	%zmm9, %zmm21, %zmm13   # zmm13 = (zmm21 * zmm9) + zmm13
	vfmadd213pd	%zmm8, %zmm22, %zmm5    # zmm5 = (zmm22 * zmm5) + zmm8
	...
	vfmadd231pd	%zmm24, %zmm6, %zmm5    # zmm5 = (zmm6 * zmm24) + zmm5
	vmulpd	%zmm5, %zmm23, %zmm5
	vsubpd	%zmm4, %zmm5, %zmm6
	vandpd	%zmm27, %zmm6, %zmm6
	vmaxpd	%zmm6, %zmm3, %zmm3
	vmovupd	%zmm5, (%r12,%r10,8)            # AlignMOV convert to UnAlignMOV 
	addq	$8, %r10
	vaddpd	%zmm12, %zmm11, %zmm9
	vaddpd	%zmm14, %zmm14, %zmm8
	valignq	$7, %zmm4, %zmm10, %zmm13       # zmm13 = zmm4[7],zmm10[0,1,2,3,4,5,6]
	valignq	$7, %zmm2, %zmm11, %zmm5        # zmm5 = zmm2[7],zmm11[0,1,2,3,4,5,6]
	valignq	$7, %zmm1, %zmm12, %zmm6        # zmm6 = zmm1[7],zmm12[0,1,2,3,4,5,6]
	valignq	$7, %zmm0, %zmm14, %zmm7        # zmm7 = zmm0[7],zmm14[0,1,2,3,4,5,6]
	vmovapd	%zmm14, %zmm0
	vmovapd	%zmm12, %zmm1
	vmovapd	%zmm11, %zmm2
...
.LBB6_22:                               #   in Loop: Header=BB6_14 Depth=2
	...
	movb	$127, %dl
	kmovd	%edx, %k1
	vexpandpd	%zmm13, %zmm0 {%k1} {z}
	vmovdqa64	%zmm10, %zmm1
	vpermt2pd	%zmm29, %zmm28, %zmm1
	vexpandpd	%zmm5, %zmm2 {%k1} {z}
	vpermt2pd	%zmm29, %zmm28, %zmm11
	vexpandpd	%zmm6, %zmm4 {%k1} {z}
	vexpandpd	%zmm7, %zmm5 {%k1} {z}
	movq	16(%rsp), %rdx                  # 8-byte Reload
	...
	vmulpd	%zmm0, %zmm20, %zmm0
	vexpandpd	%zmm9, %zmm7 {%k1} {z}
	vaddpd	%zmm2, %zmm11, %zmm2
	vaddpd	%zmm4, %zmm12, %zmm4
	vaddpd	%zmm4, %zmm2, %zmm2
	vexpandpd	%zmm8, %zmm4 {%k1} {z}
	movq	880(%rsp), %rdi                 # 8-byte Reload
	vaddpd	-64(%rdi,%rdx,8), %zmm6, %zmm6
	vexpandpd	%zmm6, %zmm6 {%k1} {z}
	vaddpd	%zmm5, %zmm1, %zmm1
	vaddpd	%zmm6, %zmm1, %zmm1
	vfmadd213pd	%zmm0, %zmm21, %zmm7    # zmm7 = (zmm21 * zmm7) + zmm0
	vfmadd231pd	%zmm2, %zmm22, %zmm4    # zmm4 = (zmm22 * zmm2) + zmm4
	vaddpd	%zmm4, %zmm7, %zmm0
	vfmadd231pd	%zmm1, %zmm24, %zmm0    # zmm0 = (zmm24 * zmm1) + zmm0
	vmulpd	%zmm0, %zmm23, %zmm0
	vsubpd	%zmm10, %zmm0, %zmm1
	vexpandpd	%zmm1, %zmm1 {%k1} {z}
	imulq	%rdx, %r10
	vpandq	%zmm27, %zmm1, %zmm1
	movq	816(%rsp), %rdi                 # 8-byte Reload
	vmovupd	%zmm0, -64(%rdi,%rdx,8)         # AlignMOV convert to UnAlignMOV 
	movq	32(%rsp), %rdx                  # 8-byte Reload
	vmovupd	(%rdx,%r11,8), %zmm10           # AlignMOV convert to UnAlignMOV 
	vmovdqu64	64(%rdx,%r11,8), %zmm4  # AlignMOV convert to UnAlignMOV 
	vmovdqu64	(%rdx,%r10,8), %zmm6    # AlignMOV convert to UnAlignMOV 
	vmovdqu64	64(%rdx,%r10,8), %zmm2  # AlignMOV convert to UnAlignMOV 
	vmovupd	(%rdi), %zmm7                   # AlignMOV convert to UnAlignMOV 
	vmovdqu64	64(%rdi), %zmm0         # AlignMOV convert to UnAlignMOV 
	vmovdqu64	(%rcx,%r11,8), %zmm8    # AlignMOV convert to UnAlignMOV 
	vmaxpd	%zmm1, %zmm3, %zmm31
	vmovdqu64	64(%rcx,%r11,8), %zmm3  # AlignMOV convert to UnAlignMOV 
	vmovapd	%zmm10, %zmm1
	vpermt2pd	%zmm29, %zmm25, %zmm1
	valignq	$1, %zmm10, %zmm4, %zmm5        # zmm5 = zmm10[1,2,3,4,5,6,7],zmm4[0]
	vpandq	%zmm26, %zmm5, %zmm9
	valignq	$1, %zmm6, %zmm2, %zmm11        # zmm11 = zmm6[1,2,3,4,5,6,7],zmm2[0]
	vaddpd	%zmm7, %zmm6, %zmm12
	...
	vpermt2pd	%zmm29, %zmm25, %zmm13
	vpandq	%zmm26, %zmm11, %zmm11
	valignq	$1, %zmm7, %zmm0, %zmm14        # zmm14 = zmm7[1,2,3,4,5,6,7],zmm0[0]
	valignq	$7, %zmm7, %zmm0, %zmm6         # zmm6 = zmm7[7],zmm0[0,1,2,3,4,5,6]
	vmovapd	%zmm7, %zmm15
	vpermt2pd	%zmm29, %zmm25, %zmm15
	vpandq	%zmm26, %zmm14, %zmm14
	valignq	$1, %zmm8, %zmm3, %zmm16        # zmm16 = zmm8[1,2,3,4,5,6,7],zmm3[0]
	vaddpd	%zmm9, %zmm1, %zmm1
	vaddpd	%zmm8, %zmm8, %zmm9
	valignq	$7, %zmm8, %zmm3, %zmm7         # zmm7 = zmm8[7],zmm3[0,1,2,3,4,5,6]
	vpermt2pd	%zmm29, %zmm25, %zmm8
	vpandq	%zmm26, %zmm16, %zmm16
	vaddpd	%zmm11, %zmm13, %zmm11
	vmovupd	(%rcx,%r10,8), %zmm13           # AlignMOV convert to UnAlignMOV 
	...
	vaddpd	%zmm16, %zmm8, %zmm8
	vaddpd	%zmm8, %zmm13, %zmm8
	vfmadd213pd	%zmm1, %zmm21, %zmm12   # zmm12 = (zmm21 * zmm12) + zmm1
	vfmadd231pd	%zmm11, %zmm22, %zmm9   # zmm9 = (zmm22 * zmm11) + zmm9
	vaddpd	%zmm9, %zmm12, %zmm1
	vfmadd231pd	%zmm8, %zmm24, %zmm1    # zmm1 = (zmm24 * zmm8) + zmm1
	vmulpd	%zmm1, %zmm23, %zmm8
	vsubpd	%zmm10, %zmm8, %zmm1
	vpternlogq	$128, %zmm26, %zmm27, %zmm1
	vmovupd	1008(%rsp), %zmm9               # 64-byte Reload
	vmaxpd	%zmm1, %zmm9, %zmm1
	movq	%r12, 816(%rsp)                 # 8-byte Spill
	vmovupd	%zmm8, (%r12)                   # AlignMOV convert to UnAlignMOV 
	vaddpd	%zmm0, %zmm2, %zmm9
	vaddpd	%zmm3, %zmm3, %zmm8
	valignq	$7, %zmm10, %zmm4, %zmm13       # zmm13 = zmm10[7],zmm4[0,1,2,3,4,5,6]
	cmpq	$9, %r15
...
# %bb.23:                               #   in Loop: Header=BB6_14 Depth=2
	...
	.p2align	4, 0x90
.LBB6_24:                               #   Parent Loop BB6_10 Depth=1
                                        #     Parent Loop BB6_14 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vmovdqu64	-64(%rcx,%r11,8), %zmm10 # AlignMOV convert to UnAlignMOV 
	vmovdqu64	-64(%rdx,%r11,8), %zmm11 # AlignMOV convert to UnAlignMOV 
	vmovdqu64	-64(%rax,%r11,8), %zmm12 # AlignMOV convert to UnAlignMOV 
	vmovdqu64	64(%r14,%r11,8), %zmm14 # AlignMOV convert to UnAlignMOV 
	valignq	$1, %zmm4, %zmm10, %zmm15       # zmm15 = zmm4[1,2,3,4,5,6,7],zmm10[0]
	valignq	$1, %zmm2, %zmm11, %zmm16       # zmm16 = zmm2[1,2,3,4,5,6,7],zmm11[0]
	valignq	$1, %zmm0, %zmm12, %zmm17       # zmm17 = zmm0[1,2,3,4,5,6,7],zmm12[0]
	valignq	$1, %zmm3, %zmm14, %zmm18       # zmm18 = zmm3[1,2,3,4,5,6,7],zmm14[0]
	vmovupd	(%r9,%r11,8), %zmm19            # AlignMOV convert to UnAlignMOV 
	vaddpd	%zmm15, %zmm13, %zmm13
	vmulpd	%zmm13, %zmm20, %zmm13
	vaddpd	%zmm16, %zmm5, %zmm5
	vaddpd	%zmm17, %zmm6, %zmm6
	vaddpd	%zmm6, %zmm5, %zmm5
	vaddpd	(%rsi,%r11,8), %zmm19, %zmm6
	vaddpd	%zmm18, %zmm7, %zmm7
	vaddpd	%zmm7, %zmm6, %zmm6
	vfmadd231pd	%zmm9, %zmm21, %zmm13   # zmm13 = (zmm21 * zmm9) + zmm13
	vfmadd213pd	%zmm8, %zmm22, %zmm5    # zmm5 = (zmm22 * zmm5) + zmm8
	...
	vmovupd	%zmm5, (%r12,%r11,8)            # AlignMOV convert to UnAlignMOV 
	addq	$8, %r11
	vaddpd	%zmm12, %zmm11, %zmm9
	vaddpd	%zmm14, %zmm14, %zmm8
	valignq	$7, %zmm4, %zmm10, %zmm13       # zmm13 = zmm4[7],zmm10[0,1,2,3,4,5,6]
	valignq	$7, %zmm2, %zmm11, %zmm5        # zmm5 = zmm2[7],zmm11[0,1,2,3,4,5,6]
	valignq	$7, %zmm0, %zmm12, %zmm6        # zmm6 = zmm0[7],zmm12[0,1,2,3,4,5,6]
	valignq	$7, %zmm3, %zmm14, %zmm7        # zmm7 = zmm3[7],zmm14[0,1,2,3,4,5,6]
	vmovapd	%zmm14, %zmm3
	vmovapd	%zmm12, %zmm0
	vmovapd	%zmm11, %zmm2
	vmovdqa64	%zmm10, %zmm4
...
.LBB6_25:                               #   in Loop: Header=BB6_14 Depth=2
	...
	vmovapd	%zmm2, %zmm11
	vmovapd	%zmm0, %zmm12
.LBB6_26:                               #   in Loop: Header=BB6_14 Depth=2
	...
	vexpandpd	%zmm7, %zmm5 {%k1} {z}
	movq	16(%rsp), %rdx                  # 8-byte Reload
	vmovupd	-64(%r11,%rdx,8), %zmm6         # AlignMOV convert to UnAlignMOV 
	vpermt2pd	%zmm29, %zmm28, %zmm12
	...
	vfmadd231pd	%zmm3, %zmm22, %zmm4    # zmm4 = (zmm22 * zmm3) + zmm4
	vaddpd	%zmm4, %zmm7, %zmm0
	vfmadd231pd	%zmm2, %zmm24, %zmm0    # zmm0 = (zmm24 * zmm2) + zmm0
	vmulpd	%zmm0, %zmm23, %zmm0
	vsubpd	%zmm10, %zmm0, %zmm2
	vexpandpd	%zmm2, %zmm2 {%k1} {z}
	imulq	%rdx, %r12
	vpandq	%zmm27, %zmm2, %zmm4
	movq	816(%rsp), %r11                 # 8-byte Reload
	vmovupd	%zmm0, -64(%r11,%rdx,8)         # AlignMOV convert to UnAlignMOV 
	movq	24(%rsp), %rdx                  # 8-byte Reload
	vmovupd	(%rdx,%r10,8), %zmm10           # AlignMOV convert to UnAlignMOV 
	vmovdqu64	64(%rdx,%r10,8), %zmm3  # AlignMOV convert to UnAlignMOV 
	vmovdqu64	(%rdx,%r12,8), %zmm6    # AlignMOV convert to UnAlignMOV 
	vmovdqu64	64(%rdx,%r12,8), %zmm2  # AlignMOV convert to UnAlignMOV 
	vmovupd	(%r11), %zmm7                   # AlignMOV convert to UnAlignMOV 
	vmovdqu64	64(%r11), %zmm0         # AlignMOV convert to UnAlignMOV 
	vmovdqu64	(%rcx,%r10,8), %zmm8    # AlignMOV convert to UnAlignMOV 
	vmaxpd	%zmm4, %zmm1, %zmm1
	vmovupd	%zmm1, 1008(%rsp)               # 64-byte Spill
	vmovdqu64	64(%rcx,%r10,8), %zmm4  # AlignMOV convert to UnAlignMOV 
	vmovapd	%zmm10, %zmm1
	vpermt2pd	%zmm29, %zmm25, %zmm1
	valignq	$1, %zmm10, %zmm3, %zmm5        # zmm5 = zmm10[1,2,3,4,5,6,7],zmm3[0]
	vpandq	%zmm26, %zmm5, %zmm9
	...
	vmovupd	(%rcx,%r12,8), %zmm13           # AlignMOV convert to UnAlignMOV 
	vmulpd	%zmm1, %zmm20, %zmm1
	vandpd	%zmm26, %zmm12, %zmm12
	vaddpd	%zmm14, %zmm15, %zmm14
	vaddpd	%zmm14, %zmm11, %zmm11
	movq	536(%rsp), %r12                 # 8-byte Reload
	vaddpd	(%r12), %zmm13, %zmm13
	vandpd	%zmm26, %zmm9, %zmm9
	vandpd	%zmm26, %zmm13, %zmm13
	vaddpd	%zmm16, %zmm8, %zmm8
	vaddpd	%zmm8, %zmm13, %zmm8
	...
	vsubpd	%zmm10, %zmm8, %zmm1
	vpternlogq	$128, %zmm26, %zmm27, %zmm1
	vmovupd	944(%rsp), %zmm9                # 64-byte Reload
	vmaxpd	%zmm1, %zmm9, %zmm1
	movq	%rbp, 208(%rsp)                 # 8-byte Spill
	vmovupd	%zmm8, (%rbp)                   # AlignMOV convert to UnAlignMOV 
	vaddpd	%zmm0, %zmm2, %zmm9
	vaddpd	%zmm4, %zmm4, %zmm8
	valignq	$7, %zmm10, %zmm3, %zmm13       # zmm13 = zmm10[7],zmm3[0,1,2,3,4,5,6]
	cmpq	$9, %r15
...
# %bb.27:                               #   in Loop: Header=BB6_14 Depth=2
	...
	movq	48(%rsp), %rcx                  # 8-byte Reload
	.p2align	4, 0x90
.LBB6_28:                               #   Parent Loop BB6_10 Depth=1
                                        #     Parent Loop BB6_14 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	vmovdqu64	-64(%rdx,%r10,8), %zmm10 # AlignMOV convert to UnAlignMOV 
	vmovdqu64	-64(%r11,%r10,8), %zmm11 # AlignMOV convert to UnAlignMOV 
	vmovdqu64	-64(%rbx,%r10,8), %zmm12 # AlignMOV convert to UnAlignMOV 
	vmovdqu64	64(%r9,%r10,8), %zmm14  # AlignMOV convert to UnAlignMOV 
	valignq	$1, %zmm3, %zmm10, %zmm15       # zmm15 = zmm3[1,2,3,4,5,6,7],zmm10[0]
	valignq	$1, %zmm2, %zmm11, %zmm16       # zmm16 = zmm2[1,2,3,4,5,6,7],zmm11[0]
	valignq	$1, %zmm0, %zmm12, %zmm17       # zmm17 = zmm0[1,2,3,4,5,6,7],zmm12[0]
	valignq	$1, %zmm4, %zmm14, %zmm18       # zmm18 = zmm4[1,2,3,4,5,6,7],zmm14[0]
	vmovupd	(%r13,%r10,8), %zmm19           # AlignMOV convert to UnAlignMOV 
	vaddpd	%zmm15, %zmm13, %zmm13
	vmulpd	%zmm13, %zmm20, %zmm13
	vaddpd	%zmm16, %zmm5, %zmm5
	vaddpd	%zmm17, %zmm6, %zmm6
	vaddpd	%zmm6, %zmm5, %zmm5
	vaddpd	(%r14,%r10,8), %zmm19, %zmm6
	vaddpd	%zmm18, %zmm7, %zmm7
	vaddpd	%zmm7, %zmm6, %zmm6
	vfmadd231pd	%zmm9, %zmm21, %zmm13   # zmm13 = (zmm21 * zmm9) + zmm13
	vfmadd213pd	%zmm8, %zmm22, %zmm5    # zmm5 = (zmm22 * zmm5) + zmm8
	...
	vandpd	%zmm27, %zmm6, %zmm6
	vmaxpd	%zmm6, %zmm1, %zmm1
	vmovupd	%zmm5, (%rcx,%r10,8)            # AlignMOV convert to UnAlignMOV 
	addq	$8, %r10
	vaddpd	%zmm12, %zmm11, %zmm9
	vaddpd	%zmm14, %zmm14, %zmm8
	valignq	$7, %zmm3, %zmm10, %zmm13       # zmm13 = zmm3[7],zmm10[0,1,2,3,4,5,6]
...
# %bb.30:
	...
	jmp	.LBB6_35
.LBB6_31:
	vmovupd	272(%rsp), %zmm2                # 64-byte Reload
	...
	vmovsd	%xmm1, 272(%rsp)                # 8-byte Spill
	vmovupd	880(%rsp), %zmm2                # 64-byte Reload
	vextractf64x4	$1, %zmm2, %ymm1
	vmaxpd	%zmm1, %zmm2, %zmm1
	vextractf128	$1, %ymm1, %xmm2
	vmaxpd	%xmm2, %xmm1, %xmm1
	vshufpd	$1, %xmm1, %xmm1, %xmm2         # xmm2 = xmm1[1,0]
	vmaxsd	%xmm2, %xmm1, %xmm1
	vmovsd	%xmm1, 816(%rsp)                # 8-byte Spill
	vmovupd	208(%rsp), %zmm2                # 64-byte Reload
	vextractf64x4	$1, %zmm2, %ymm1
	vmaxpd	%zmm1, %zmm2, %zmm1
	vextractf128	$1, %ymm1, %xmm2
	vmaxpd	%xmm2, %xmm1, %xmm1
...
# %bb.72:
	movq	1080(%rsp), %rax
	movq	-24(%rax), %rax
	leaq	1080(%rsp,%rax), %rdi
	movl	1112(%rsp,%rax), %esi
	orl	$4, %esi
.Ltmp48:
	callq	_ZNSt9basic_iosIcSt11char_traitsIcEE5clearESt12_Ios_Iostate
.Ltmp49:
...
# %bb.81:
	movq	1592(%rsp), %rax
	movq	-24(%rax), %rax
	leaq	1592(%rsp,%rax), %rdi
	movl	1624(%rsp,%rax), %esi
	orl	$4, %esi
.Ltmp62:
	callq	_ZNSt9basic_iosIcSt11char_traitsIcEE5clearESt12_Ios_Iostate
.Ltmp63:
