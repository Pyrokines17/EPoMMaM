...
# %bb.1:
	...
	vmovdqu	%xmm1, 32(%rsp)                 # 16-byte Spill
                                        # AlignMOV convert to UnAlignMOV 
...
.LBB7_5:
	...
	vmovups	32(%rsp), %xmm0                 # 16-byte Reload
                                        # AlignMOV convert to UnAlignMOV 
	vmovlps	%xmm0, 56(%rsp)                 # 8-byte Folded Spill
	cmpq	$8, %rbx
	jb	.LBB7_7
# %bb.6:
	movq	%r12, %rdx
...
# %bb.8:
	vbroadcastsd	16(%rsp), %zmm0         # 16-byte Folded Reload
	vbroadcastsd	64(%rsp), %zmm1         # 16-byte Folded Reload
	vbroadcastsd	128(%rsp), %zmm2        # 16-byte Folded Reload
	vbroadcastsd	112(%rsp), %zmm3        # 16-byte Folded Reload
	leaq	-8(%rbp), %rcx
	leaq	(,%rbp,8), %rax
	...
	leaq	128(%rbx,%rbp,8), %rsi
	movq	%rsi, 176(%rsp)                 # 8-byte Spill
	subq	$-128, %rax
	movq	%rax, 200(%rsp)                 # 8-byte Spill
	xorl	%esi, %esi
	vmovupd	.LCPI7_6(%rip), %zmm4           # zmm4 = [8,0,1,2,3,4,5,6]
                                        # AlignMOV convert to UnAlignMOV 
	vpmovsxbq	.LCPI7_11(%rip), %zmm5  # zmm5 = [0,18446744073709551615,18446744073709551615,18446744073709551615,18446744073709551615,18446744073709551615,18446744073709551615,18446744073709551615]
	vbroadcastsd	.LCPI7_4(%rip), %zmm6   # zmm6 = [2.5E-1,2.5E-1,2.5E-1,2.5E-1,2.5E-1,2.5E-1,2.5E-1,2.5E-1]
	vxorpd	%xmm7, %xmm7, %xmm7
	vpbroadcastq	.LCPI7_8(%rip), %zmm8   # zmm8 = [NaN,NaN,NaN,NaN,NaN,NaN,NaN,NaN]
	movb	$127, %al
	kmovd	%eax, %k1
	vmovupd	.LCPI7_9(%rip), %zmm9           # zmm9 = [8,2,3,4,5,6,7,0]
                                        # AlignMOV convert to UnAlignMOV 
...
.LBB7_12:                               #   in Loop: Header=BB7_13 Depth=2
	...
	leaq	(%r13,%rbp,8), %rbx
	movq	32(%rsp), %r12                  # 8-byte Reload
	vmovupd	-64(%rbx,%r12,8), %zmm11        # AlignMOV convert to UnAlignMOV 
	movq	%r13, %rbx
	leaq	(%r13,%r10,8), %r10
	vaddpd	-64(%r10,%r12,8), %zmm11, %zmm11
	movq	128(%rsp), %rbp                 # 8-byte Reload
	leaq	(%rbp,%r9,8), %r9
	vexpandpd	%zmm21, %zmm12 {%k1} {z}
	vmovdqa64	%zmm20, %zmm13
	vpermt2pd	%zmm7, %zmm9, %zmm13
	vexpandpd	%zmm15, %zmm14 {%k1} {z}
	vpermt2pd	%zmm7, %zmm9, %zmm22
	vexpandpd	%zmm16, %zmm15 {%k1} {z}
	vpermt2pd	%zmm7, %zmm9, %zmm23
	vexpandpd	%zmm17, %zmm16 {%k1} {z}
	vaddpd	%zmm12, %zmm13, %zmm12
	vexpandpd	%zmm19, %zmm17 {%k1} {z}
	vmulpd	%zmm17, %zmm1, %zmm17
	vaddpd	%zmm14, %zmm22, %zmm14
	vaddpd	%zmm15, %zmm23, %zmm15
	vaddpd	%zmm15, %zmm14, %zmm14
	vexpandpd	%zmm18, %zmm15 {%k1} {z}
	vexpandpd	%zmm11, %zmm11 {%k1} {z}
	vaddpd	%zmm16, %zmm13, %zmm13
	vaddpd	%zmm11, %zmm13, %zmm11
	vfmadd231pd	%zmm12, %zmm0, %zmm17   # zmm17 = (zmm0 * zmm12) + zmm17
	vfmadd231pd	%zmm14, %zmm2, %zmm15   # zmm15 = (zmm2 * zmm14) + zmm15
	vaddpd	%zmm15, %zmm17, %zmm12
	vfmadd231pd	%zmm6, %zmm11, %zmm12   # zmm12 = (zmm11 * zmm6) + zmm12
	vmulpd	%zmm12, %zmm3, %zmm11
	vmovupd	%zmm11, -64(%r9,%r12,8)         # AlignMOV convert to UnAlignMOV 
	vsubpd	%zmm20, %zmm11, %zmm11
	vexpandpd	%zmm11, %zmm11 {%k1} {z}
	vpandq	%zmm8, %zmm11, %zmm11
	vmaxpd	%zmm11, %zmm10, %zmm10
...
.LBB7_13:                               #   Parent Loop BB7_10 Depth=1
	...
	imulq	%r12, %r10
	vmovupd	(%r13,%r9,8), %zmm20            # AlignMOV convert to UnAlignMOV 
	vmovdqu64	64(%r13,%r9,8), %zmm13  # AlignMOV convert to UnAlignMOV 
	vmovdqu64	(%r13,%rbp,8), %zmm16   # AlignMOV convert to UnAlignMOV 
	vmovdqu64	64(%r13,%rbp,8), %zmm12 # AlignMOV convert to UnAlignMOV 
	vmovupd	(%r13,%r10,8), %zmm17           # AlignMOV convert to UnAlignMOV 
	vmovdqu64	64(%r13,%r10,8), %zmm11 # AlignMOV convert to UnAlignMOV 
	vmovdqu64	(%rbx,%r9,8), %zmm18    # AlignMOV convert to UnAlignMOV 
	vmovdqu64	64(%rbx,%r9,8), %zmm14  # AlignMOV convert to UnAlignMOV 
	vmovapd	%zmm20, %zmm19
	vpermt2pd	%zmm7, %zmm4, %zmm19
	valignq	$1, %zmm20, %zmm13, %zmm15      # zmm15 = zmm20[1,2,3,4,5,6,7],zmm13[0]
	vpandq	%zmm5, %zmm15, %zmm21
	valignq	$1, %zmm16, %zmm12, %zmm22      # zmm22 = zmm16[1,2,3,4,5,6,7],zmm12[0]
	vaddpd	%zmm17, %zmm16, %zmm23
	valignq	$7, %zmm16, %zmm12, %zmm15      # zmm15 = zmm16[7],zmm12[0,1,2,3,4,5,6]
	vmovapd	%zmm16, %zmm24
	vpermt2pd	%zmm7, %zmm4, %zmm24
	vpandq	%zmm5, %zmm22, %zmm22
	valignq	$1, %zmm17, %zmm11, %zmm25      # zmm25 = zmm17[1,2,3,4,5,6,7],zmm11[0]
	valignq	$7, %zmm17, %zmm11, %zmm16      # zmm16 = zmm17[7],zmm11[0,1,2,3,4,5,6]
	vmovapd	%zmm17, %zmm26
	vpermt2pd	%zmm7, %zmm4, %zmm26
	vpandq	%zmm5, %zmm25, %zmm25
	valignq	$1, %zmm18, %zmm14, %zmm27      # zmm27 = zmm18[1,2,3,4,5,6,7],zmm14[0]
	vaddpd	%zmm21, %zmm19, %zmm19
	vaddpd	%zmm18, %zmm18, %zmm21
	valignq	$7, %zmm18, %zmm14, %zmm17      # zmm17 = zmm18[7],zmm14[0,1,2,3,4,5,6]
	vpermt2pd	%zmm7, %zmm4, %zmm18
	vpandq	%zmm5, %zmm27, %zmm27
	vaddpd	%zmm22, %zmm24, %zmm22
	vmovupd	(%rbx,%rbp,8), %zmm24           # AlignMOV convert to UnAlignMOV 
	vmulpd	%zmm19, %zmm0, %zmm19
	vandpd	%zmm5, %zmm23, %zmm23
	vaddpd	%zmm25, %zmm26, %zmm25
	vaddpd	%zmm25, %zmm22, %zmm22
	vaddpd	(%rbx,%r10,8), %zmm24, %zmm24
	vandpd	%zmm5, %zmm21, %zmm21
	vandpd	%zmm5, %zmm24, %zmm24
	vaddpd	%zmm27, %zmm18, %zmm18
	vaddpd	%zmm18, %zmm24, %zmm18
	vfmadd213pd	%zmm19, %zmm1, %zmm23   # zmm23 = (zmm1 * zmm23) + zmm19
	vfmadd231pd	%zmm22, %zmm2, %zmm21   # zmm21 = (zmm2 * zmm22) + zmm21
	vaddpd	%zmm21, %zmm23, %zmm19
	vfmadd231pd	%zmm6, %zmm18, %zmm19   # zmm19 = (zmm18 * zmm6) + zmm19
	vmulpd	%zmm19, %zmm3, %zmm18
	vsubpd	%zmm20, %zmm18, %zmm19
	vpternlogq	$128, %zmm8, %zmm5, %zmm19
	vmaxpd	%zmm19, %zmm10, %zmm10
	vmovupd	%zmm18, (%rdx,%r9,8)            # AlignMOV convert to UnAlignMOV 
	vaddpd	%zmm11, %zmm12, %zmm19
	vaddpd	%zmm14, %zmm14, %zmm18
	valignq	$7, %zmm20, %zmm13, %zmm21      # zmm21 = zmm20[7],zmm13[0,1,2,3,4,5,6]
	cmpq	$9, %rcx
	jb	.LBB7_11
...
.LBB7_15:                               #   Parent Loop BB7_10 Depth=1
	...
	vmovdqu64	-64(%rdi,%r13,8), %zmm20 # AlignMOV convert to UnAlignMOV 
	vmovdqu64	-64(%r8,%r13,8), %zmm22 # AlignMOV convert to UnAlignMOV 
	vmovdqu64	-64(%r14,%r13,8), %zmm23 # AlignMOV convert to UnAlignMOV 
	vmovdqu64	-64(%rsi,%r13,8), %zmm24 # AlignMOV convert to UnAlignMOV 
	valignq	$1, %zmm13, %zmm20, %zmm25      # zmm25 = zmm13[1,2,3,4,5,6,7],zmm20[0]
	valignq	$1, %zmm12, %zmm22, %zmm26      # zmm26 = zmm12[1,2,3,4,5,6,7],zmm22[0]
	valignq	$1, %zmm11, %zmm23, %zmm27      # zmm27 = zmm11[1,2,3,4,5,6,7],zmm23[0]
	valignq	$1, %zmm14, %zmm24, %zmm28      # zmm28 = zmm14[1,2,3,4,5,6,7],zmm24[0]
	vmovupd	(%r15,%r13,8), %zmm29           # AlignMOV convert to UnAlignMOV 
	vaddpd	%zmm25, %zmm21, %zmm21
	vmulpd	%zmm21, %zmm0, %zmm21
	vaddpd	%zmm26, %zmm15, %zmm15
	vaddpd	%zmm27, %zmm16, %zmm16
	vaddpd	%zmm16, %zmm15, %zmm15
	vaddpd	(%rax,%r13,8), %zmm29, %zmm16
	vaddpd	%zmm28, %zmm17, %zmm17
	vaddpd	%zmm17, %zmm16, %zmm16
	vfmadd231pd	%zmm19, %zmm1, %zmm21   # zmm21 = (zmm1 * zmm19) + zmm21
	vfmadd213pd	%zmm18, %zmm2, %zmm15   # zmm15 = (zmm2 * zmm15) + zmm18
	vaddpd	%zmm15, %zmm21, %zmm15
	vfmadd231pd	%zmm6, %zmm16, %zmm15   # zmm15 = (zmm16 * zmm6) + zmm15
	vmulpd	%zmm15, %zmm3, %zmm15
	vsubpd	%zmm13, %zmm15, %zmm16
	vandpd	%zmm8, %zmm16, %zmm16
	vmaxpd	%zmm16, %zmm10, %zmm10
	vmovupd	%zmm15, (%r11,%r13,8)           # AlignMOV convert to UnAlignMOV 
	addq	$8, %r13
	vaddpd	%zmm23, %zmm22, %zmm19
	vaddpd	%zmm24, %zmm24, %zmm18
	valignq	$7, %zmm13, %zmm20, %zmm21      # zmm21 = zmm13[7],zmm20[0,1,2,3,4,5,6]
	valignq	$7, %zmm12, %zmm22, %zmm15      # zmm15 = zmm12[7],zmm22[0,1,2,3,4,5,6]
	valignq	$7, %zmm11, %zmm23, %zmm16      # zmm16 = zmm11[7],zmm23[0,1,2,3,4,5,6]
	valignq	$7, %zmm14, %zmm24, %zmm17      # zmm17 = zmm14[7],zmm24[0,1,2,3,4,5,6]
	vmovapd	%zmm24, %zmm14
	vmovapd	%zmm23, %zmm11
	vmovapd	%zmm22, %zmm12
	vmovdqa64	%zmm20, %zmm13
...
# %bb.64:
	movq	728(%rsp), %rax
	movq	-24(%rax), %rax
	leaq	728(%rsp,%rax), %rdi
	movl	760(%rsp,%rax), %esi
	orl	$4, %esi
.Ltmp62:
	callq	_ZNSt9basic_iosIcSt11char_traitsIcEE5clearESt12_Ios_Iostate
.Ltmp63:
